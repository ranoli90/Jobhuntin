...
def main():
    ...
    for service in services:
        ...
        if service_type == 'web_service':
            ...
            print("   🔧 Background worker - checking recent activity...")
            ...
            if deploys_response.status_code == 200:
                ...
                if deploys:
                    ...
                    if deploy_status not in ['live', 'succeeded', 'ready']:
                        ...
                        print("   ✅ Latest deploy successful")
                else:
                    print("   ⚠️  No deploy history found")

        elif service_type == 'static_site':
            print("   🌐 Static site - checking accessibility...")
        ...
        if service_details:
            ...
            if env_vars:
                ...
                if missing_vars:
                    ...
                    print("   ✅ Critical variables present")

        # Check suspension details
        if suspended:
            print("   🚨 SERVICE IS SUSPENDED!")
