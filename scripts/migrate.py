...
class MigrationSystem:
    ...
    async def _apply_migration(self, version: str, filename: str, content: str, checksum: str):
    ...
    async def migrate(self, target_version: Optional[str] = None, dry_run: bool = False):
    ...
    async def rollback(self, target_version: str, dry_run: bool = False):
        ...
        if not to_rollback:
            print(f"No migrations to rollback (target version {target_version} is current or newer)")
            return
