    ...
    async with async_playwright() as p:
        ...
        try:
            start_btn = page.locator(
                'button:has-text("Start setup"), button:has-text("Continue"):not(:has-text("Restart"))'
            ).first
        ...
        try:
            ...
            add_btn = page.locator(
                'button:has-text("Add"), button:has-text("Add Your First Skill"), button:has-text("Add Missing Skill")'
            ).first
            if await add_btn.is_visible(timeout=5000):
                ...
                for skill in skills:
                    ...
                    skill_input = page.locator(
                        'input[placeholder*="skill" i], input[placeholder*="Skill name" i]'
                    ).first
                    if await skill_input.is_visible(timeout=3000):
                        ...
                        add_skill_btn = page.locator(
                            'button[type="submit"], button:has-text("Add Skill"), button:has-text("Add")'
                        ).first
                        ...
                        add_btn = page.locator(
                            'button:has-text("Add"), button:has-text("Add Missing Skill")'
                        ).first
        ...
        try:
            save_skills = page.locator(
                'button[data-onboarding-next], button:has-text("Save & Continue"), button:has-text("Continue"):not(:has-text("Restart"))'
            ).first
        ...
        try:
            ...
            continue_btn = page.locator(
                'button[data-onboarding-next], button:has-text("Continue"):not(:has-text("Restart"))'
            ).first
        ...
        try:
            location = page.locator(
                'input[placeholder*="location" i], input[name*="location" i]'
            ).first
            ...
            role = page.locator(
                'input[placeholder*="role" i], input[name*="role" i]'
            ).first
            ...
            save_prefs = page.locator(
                'button:has-text("Save preferences"), button[data-onboarding-next], button:has-text("Continue"):not(:has-text("Restart"))'
            ).first
        ...
        try:
            complete = page.locator(
                'button:has-text("Complete"), button:has-text("Finish"), button:has-text("Complete Onboarding")'
            ).first
