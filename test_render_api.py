...
class RenderAPITester:
    def __init__(self):
        ...
        self.api_base = "https://jobhuntin-api.onrender.com"  # Typical Render URL pattern
        self.session = None
    ...
    async def test_health_endpoints(self):
        ...
        for method, path, data, headers, expected in tests:
            ...
            print(f"  {status} {result['endpoint']} - {result['status_code']} ({result['duration_seconds']:.2f}s)")
    ...
    async def generate_report(self):
        ...
        print(f"   Report saved to: render_api_test_report.json")
