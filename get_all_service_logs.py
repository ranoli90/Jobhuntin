    ...
    if audit_logs:
        ...
        for service in services:
            ...
            if service_errors:
                ...
                print("  ✅ No errors found in audit logs")
    ...
    for service in services:
        ...
        if deploys:
            ...
            if failed_deploys:
                ...
                print("   ✅ All recent deploys successful")
        else:
            print("   ⚠️  Could not get deploy information")

        # Get service events
        print("   📅 Getting service events...")
