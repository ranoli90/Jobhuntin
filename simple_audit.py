...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("simple_audit.log")],
)
        ...
        try:
            with open(migration_file, "r", encoding="utf-8") as f:
                ...
                if (
                    ...
                    or f"CREATE TABLE IF NOT EXISTS.*{table_name}" in content
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("packages/backend/domain/tenant.py"),
                ),
                (
                    "packages/backend/domain/repositories.py",
                    check_file_exists("packages/backend/domain/repositories.py"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_file_exists("shared/logging_config.py"),
                ),
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_file_exists("apps/api/admin_security.py"),
                ),
            ],
        ),
    ]
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/web/src/components/ui/ButtonStyles.tsx"),
                ),
                (
                    "apps/web/src/components/ui/CardStyles.tsx",
                    check_file_exists("apps/web/src/components/ui/CardStyles.tsx"),
                ),
                (
                    "apps/web/src/components/ui/SkeletonLoader.tsx",
                    check_file_exists("apps/web/src/components/ui/SkeletonLoader.tsx"),
                ),
            ],
        ),
        (
            ...
            [
                ...
                (
                    ...
                    check_file_exists("apps/web/src/styles/globals.css"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/web/src/styles/typography.css"),
                ),
                ("apps/web/src/index.css", check_file_exists("apps/web/src/index.css")),
            ],
        ),
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/web/src/layouts/AppLayout.tsx"),
                ),
                (
                    "apps/web/src/components/marketing/SwitchFrom.tsx",
                    check_file_exists(
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/web/src/components/FocusTrap.tsx"),
                ),
                (
                    "apps/web/src/components/ui/ButtonStyles.tsx",
                    check_file_exists("apps/web/src/components/ui/ButtonStyles.tsx"),
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("packages/backend/domain/document_processor.py"),
                ),
                (
                    "packages/backend/domain/skills_taxonomy.py",
                    check_file_exists("packages/backend/domain/skills_taxonomy.py"),
                ),
                (
                    "packages/backend/domain/resume.py",
                    check_file_exists("packages/backend/domain/resume.py"),
                ),
                (
                    "packages/backend/domain/ab_testing.py",
                    check_file_exists("packages/backend/domain/ab_testing.py"),
                ),
                (
                    "packages/backend/domain/llm_career_path.py",
                    check_file_exists("packages/backend/domain/llm_career_path.py"),
                ),
                (
                    "packages/backend/domain/voice_interviews.py",
                    check_file_exists("packages/backend/domain/voice_interviews.py"),
                ),
                (
                    "packages/backend/domain/ai_onboarding.py",
                    check_file_exists("packages/backend/domain/ai_onboarding.py"),
                ),
            ],
        ),
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/ai_endpoints.py"),
                ),
                ("apps/api/skills.py", check_file_exists("apps/api/skills.py")),
                (
                    "apps/api/ats_recommendations.py",
                    check_file_exists("apps/api/ats_recommendations.py"),
                ),
                (
                    "apps/api/voice_interviews.py",
                    check_file_exists("apps/api/voice_interviews.py"),
                ),
                (
                    "apps/api/llm_career_path.py",
                    check_file_exists("apps/api/llm_career_path.py"),
                ),
                (
                    "apps/api/ai_onboarding.py",
                    check_file_exists("apps/api/ai_onboarding.py"),
                ),
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_table_exists("ab_testing_experiments"),
                ),
                ("interview_sessions", check_table_exists("interview_sessions")),
                (
                    "voice_interview_sessions",
                    check_table_exists("voice_interview_sessions"),
                ),
            ],
        ),
    ]
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("packages/backend/domain/agent_improvements.py"),
                ),
                (
                    "packages/backend/domain/oauth_handler.py",
                    check_file_exists("packages/backend/domain/oauth_handler.py"),
                ),
                (
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/agent_improvements_endpoints.py"),
                ),
                (
                    "apps/api/oauth_endpoints.py",
                    check_file_exists("apps/api/oauth_endpoints.py"),
                ),
                (
                    "apps/api/concurrent_usage_endpoints.py",
                    check_file_exists("apps/api/concurrent_usage_endpoints.py"),
                ),
                (
                    "apps/api/dlq_endpoints.py",
                    check_file_exists("apps/api/dlq_endpoints.py"),
                ),
                (
                    "apps/api/screenshot_endpoints.py",
                    check_file_exists("apps/api/screenshot_endpoints.py"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_table_exists("concurrent_usage_sessions"),
                ),
                ...
                (
                    ...
                    check_table_exists("document_type_tracking"),
                ),
                (
                    "agent_performance_metrics",
                    check_table_exists("agent_performance_metrics"),
                ),
            ],
        ),
    ]
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/communication_endpoints.py"),
                ),
            ],
        ),
        (
            ...
            [
                (
                    ...
                    check_table_exists("email_communications_log"),
                ),
                ...
                (
                    ...
                    check_table_exists("notification_semantic_tags"),
                ),
                ("user_interests", check_table_exists("user_interests")),
                (
                    "notification_delivery_tracking",
                    check_table_exists("notification_delivery_tracking"),
                ),
            ],
        ),
    ]
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_file_exists("packages/backend/domain/application_export.py"),
                ),
                (
                    "packages/backend/domain/follow_up_reminders.py",
                    check_file_exists("packages/backend/domain/follow_up_reminders.py"),
                ),
                (
                    "packages/backend/domain/answer_memory.py",
                    check_file_exists("packages/backend/domain/answer_memory.py"),
                ),
                (
                    "packages/backend/domain/multi_resume.py",
                    check_file_exists("packages/backend/domain/multi_resume.py"),
                ),
                (
                    "packages/backend/domain/application_notes.py",
                    check_file_exists("packages/backend/domain/application_notes.py"),
                ),
            ],
        ),
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/user_experience_endpoints.py"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("migrations/008_performance_indexes.sql"),
                ),
                (
                    "migrations/009_missing_indexes.sql",
                    check_file_exists("migrations/009_missing_indexes.sql"),
                ),
            ],
        ),
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/monitoring_endpoints.py"),
                ),
                (
                    "apps/web/src/components/PerformanceMonitor.tsx",
                    check_file_exists("apps/web/src/components/PerformanceMonitor.tsx"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                (
                    ...
                    check_file_exists("apps/api/dependencies.py"),
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                ...
                (
                    ...
                    check_file_exists(".github/workflows/deploy-render-seo.yml"),
                ),
            ],
        ),
        (
