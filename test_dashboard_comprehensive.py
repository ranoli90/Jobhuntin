...
async def test_dashboard_comprehensive():
    async with async_playwright() as p:
        ...
        try:
            await page.goto('http://localhost:5173/app/applications', wait_until='networkidle', timeout=30000)
            await asyncio.sleep(3)
        ...
        try:
            await page.goto('http://localhost:5173/app/settings', wait_until='networkidle', timeout=30000)
            await asyncio.sleep(3)
