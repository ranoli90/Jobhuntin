...
def verify_phase_12_1():
    ...
    # Test API endpoints
    try:
        from apps.api.agent_improvements_endpoints import router
...
def verify_phase_13_1():
    ...
    # Test API endpoints
    try:
        from apps.api.communication_endpoints import router
...
def verify_phase_14_1():
    ...
    # Test API endpoints
    try:
        from apps.api.user_experience_endpoints import router
