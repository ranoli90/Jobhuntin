...
class DLQManager:
            ...
            async with self.pool.acquire() as conn:
                ...
                async with conn.transaction():
                    ...
                    logger.info(
                        ...
                        dlq_item.application_id, item_id
                    )
    ...
    async def batch_retry_applications(
        ...
        logger.info(
            "Batch retry completed: %d/%d successful",
        ...
        try:
            ...
            async with self.pool.acquire() as conn:
                ...
                logger.info(
                    ...
                    deleted_count, tenant_id, failure_reason, older_than_days
                )
                ...
                "recent_items": [
                    {
                        ...
                        "last_error": item.last_error[:200] + "..." if len(item.last_error) > 200 else item.last_error,
                    }
                    for item in items
                ]
            }
