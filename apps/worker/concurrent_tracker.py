...
class ConcurrentUsageTracker:
    ...
    async def can_start_task(self, task_id: str, tenant_id: Optional[str] = None) -> bool:
            ...
            if tenant_id:
                ...
                if current_tenant_usage >= self.max_per_tenant:
                    logger.warning(
                        ...
                        tenant_id, current_tenant_usage, self.max_per_tenant
                    )
                    return False
    ...
    async def start_task(self, task_id: str, tenant_id: Optional[str] = None) -> bool:
        ...
        async with self._lock:
            ...
            logger.info(
                ...
                self._stats.total_active, self.max_concurrent,
                self._tenant_usage.get(tenant_id or "none", 0), self.max_per_tenant
            )
