          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  id="exit-intent-desc"
                  className="text-white/70 mb-6 leading-relaxed font-medium"
                >
                  Join{" "}
                  <span className="font-bold text-white">
                    thousands of job seekers
                  </span>{" "}
                  who automated their job search. Get your first interviews in
                  just 48 hours.
                </p>
...
function FAQItem({
  ...
  return (
    <div className="border-b border-[#E9E9E7] pb-6">
      ...
      >
        <span className="font-bold text-lg text-[#2D2A26] pr-4">
          {question}
        </span>
        <motion.div
        ...
        >
          <ChevronDown
            className="w-5 h-5 text-[#787774] flex-shrink-0"
            aria-hidden="true"
          />
        </motion.div>
      </button>
      ...
      >
        <p className="pt-3 text-[#787774] font-medium leading-relaxed">
          {answer}
        </p>
      </motion.div>
    </div>
    ...
    <div className="min-h-screen bg-[#F7F6F3] text-[#2D2A26] pb-20">
      ...
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: "Pricing", url: "https://jobhuntin.com/pricing" },
        ]}
        ...
        schema={[
          {
            ...
            name: "JobHuntin Pro",
            description:
              "AI-powered job application automation with unlimited applications, resume tailoring, and interview coaching.",
            offers: [
              {
                "@type": "Offer",
                name: "Free Tier",
      ...
      >
        ...
        >
          <path
            d="M-100 200 C200 120, 500 280, 800 200 S1200 100, 1540 180"
            stroke="#455DD3"
            strokeOpacity="0.15"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M-100 250 C300 170, 600 330, 900 250 S1300 150, 1540 230"
            stroke="#7B93DB"
            strokeOpacity="0.1"
            strokeWidth="1.5"
            fill="none"
        ...
        <div className="relative max-w-[1080px] mx-auto px-6 py-20 sm:py-28">
          ...
          <h1
            className="text-[clamp(2.25rem,5vw,3.5rem)] font-bold text-white leading-tight mb-4"
      ...
      <main className="max-w-[900px] mx-auto px-6 -mt-12 relative z-10">
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[#787774] mb-2">
                Free forever
              </p>
              <h2
                id="pricing-free-heading"
                className="text-3xl sm:text-4xl font-bold text-[#2D2A26] mb-3"
                style={{ letterSpacing: "-1px" }}
              >
                20 applications per week
              </h2>
              <p className="text-[#787774] font-medium mb-6 max-w-md">
                AI-powered applications, smart matching, resume parsing, and
                tracking. Resets every Monday.
              </p>
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 40% at 100% 0%, rgba(69,93,211,0.1) 0%, transparent 70%)",
            }}
          />
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              ...
              <p className="text-white/70 font-medium mb-6 max-w-md">
                Everything in Free, plus resume tailoring, cover letters,
                stealth mode, and priority support.
              </p>
              <ul className="space-y-3">
                {[
        ...
        <div className="mt-16 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-[#787774] mb-4">
            Trusted by job seekers at
          </p>
          <div className="flex justify-center flex-wrap gap-8 text-[#787774]">
            {["Walmart", "Target", "Amazon", "Costco", "Home Depot"].map(
              (c) => (
                <span key={c} className="text-lg font-bold">
                  {c}
                </span>
              ),
            )}
        ...
        <div className="mt-24 border-t border-[#E9E9E7] pt-16">
          <h2
            className="text-2xl font-bold text-center mb-12 text-[#2D2A26]"
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {[
              {
                q: "What happens after my 20 free applications?",
                a: "Your free applications reset every Monday at midnight UTC. If you need more before the reset, you can upgrade to Pro for unlimited applications.",
              },
              {
                q: "Can I cancel Pro anytime?",
                a: "Yes. Cancel anytime in your dashboard with one click. No phone calls, no hassle. You'll keep access until your billing period ends.",
              },
              {
                q: "What happens after the first month?",
                a: "After your $10 first month, you'll be charged $29/month. We'll send you a reminder 3 days before the price change.",
              },
              {
                q: "Is my data safe?",
                a: "We use bank-level encryption. Your resume is only shared with employers you choose to apply to. We never sell your data.",
              },
              {
                q: "How does the weekly reset work?",
                a: "Every Monday at midnight UTC, your free application count resets to 20. Unused applications don't roll over.",
              },
              {
                q: "Can I get a refund?",
                a: "If you're not satisfied, contact us within 7 days of upgrading for a full refund. No questions asked.",
              },
            ].map((item, index) => (
              <FAQItem
                key={index}
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {["lazyapply", "jobright", "simplify"].map((slug) => (
              <Link
                key={slug}
                to={`/pricing-vs/${slug}`}
                className="bg-white p-5 rounded-2xl border border-slate-100 hover:border-primary-200 shadow-sm text-center transition-all"
              >
                <p className="font-bold text-slate-900 capitalize">
                  {slug.replaceAll("-", " ")} vs JobHuntin
                </p>
