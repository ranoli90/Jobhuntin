    ...
    return (
      <div className="flex items-center gap-3 p-4 rounded-lg bg-[#F7F6F3] border border-[#E9E9E7]">
        ...
        <button 
          ...
          className="text-xs font-medium text-black hover:text-[#37352F] transition-colors"
        >
          Change
        </button>
      </div>
    ...
    <div className="w-full max-w-md">
      <form onSubmit={onSubmit} className="flex flex-col gap-3">
        <input 
          ...
          className={cn(
            "w-full h-12 px-4 rounded-md border bg-white text-black placeholder:text-[#9B9A97]",
        ...
        <button 
          ...
          className={cn(
            ...
            "bg-black text-white hover:bg-[#37352F] focus:ring-black",
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#features" className="text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Features
              </a>
              <a href="#how-it-works" className="text-sm font-medium text-black hover:text-[#787774] transition-colors">
                How it works
              </a>
              <a href="#pricing" className="text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Pricing
              </a>
              <Link to="/login" className="text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Sign in
              </Link>
            </div>
            ...
            <button 
              onClick={toggle} 
              className="md:hidden p-2 rounded text-black hover:bg-[#F7F6F3] transition-colors"
        ...
        {isOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-b border-[#E9E9E7] shadow-lg">
            <div className="max-w-6xl mx-auto px-8 py-4 space-y-4">
              <a href="#features" onClick={close} className="block text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Features
              </a>
              <a href="#how-it-works" onClick={close} className="block text-sm font-medium text-black hover:text-[#787774] transition-colors">
                How it works
              </a>
              <a href="#pricing" onClick={close} className="block text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Pricing
              </a>
              <Link to="/login" onClick={close} className="block text-sm font-medium text-black hover:text-[#787774] transition-colors">
                Sign in
              </Link>
            </div>
          </div>
      ...
      <section id="main-content" className="bg-white">
        <div className="max-w-6xl mx-auto px-8 pt-24 pb-32">
          <div className="max-w-4xl mx-auto text-center">
            <FadeIn>
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tight text-black leading-tight mb-8">
                One resume.<br className="hidden sm:block" />
                Zero applications.
              </h1>
            </FadeIn>
            <FadeIn delay={100}>
              <p className="text-xl sm:text-2xl text-[#787774] max-w-3xl mx-auto leading-relaxed mb-12">
                Upload your resume once. Our AI finds matching jobs, tailors every application, and submits while you sleep.
              </p>
            </FadeIn>
            <FadeIn delay={200}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
                <Link to="/login" className="inline-flex items-center gap-2 h-14 px-8 rounded bg-black text-white font-medium hover:bg-[#2F2E2B] transition-colors">
                  Get started free
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <a href="#how-it-works" className="inline-flex items-center gap-2 h-14 px-8 rounded border border-[#E9E9E7] text-black font-medium hover:bg-[#F7F6F3] transition-colors">
                  See how it works
        ...
        <div className="max-w-6xl mx-auto px-8">
          <FadeIn>
            <div className="text-center mb-20">
              <p className="text-sm font-medium text-black uppercase tracking-wider mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12">
              {[
                ...
                <div key={company} className="flex items-center justify-center p-8 bg-white rounded-lg border border-[#E9E9E7]">
        ...
        <div className="max-w-6xl mx-auto px-8">
          <FadeIn>
            <div className="text-center max-w-4xl mx-auto mb-20">
              <h2 className="text-5xl sm:text-6xl font-black tracking-tight text-black mb-8">
                Everything you need to<br className="hidden sm:block" />
                automate your job search
              </h2>
              <p className="text-xl text-[#787774] max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <FadeIn key={feature.title} delay={index * 100}>
                <div className="p-12 bg-white rounded-xl border border-[#E9E9E7] hover:border-black transition-colors">
                  <div className="text-4xl mb-6">{feature.icon}</div>
                  <h3 className="text-2xl font-semibold text-black mb-4">{feature.title}</h3>
                  <p className="text-[#787774] leading-relaxed text-lg">{feature.description}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      {/* ═══════════════════════════════════════════════════════════════
          HOW IT WORKS
          ═══════════════════════════════════════════════════════════════ */}
      <section id="how-it-works" className="bg-[#F7F6F3] py-24">
        <div className="max-w-6xl mx-auto px-8">
          <FadeIn>
            <div className="text-center max-w-4xl mx-auto mb-20">
              <h2 className="text-5xl sm:text-6xl font-black tracking-tight text-black mb-8">
            ...
            {[
              ...
              <FadeIn key={step.title} delay={index * 150}>
                <div className="text-center">
                  <div className="text-5xl font-black text-black mb-6">{step.step}</div>
                  <h3 className="text-2xl font-semibold text-black mb-4">{step.title}</h3>
                  <p className="text-[#787774] leading-relaxed text-lg">{step.description}</p>
                </div>
              </FadeIn>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-8">
          <FadeIn>
            <div className="grid md:grid-cols-3 gap-20 text-center">
              <div>
                <div className="text-6xl font-black text-black mb-4">500K+</div>
                <p className="text-xl font-medium text-black">Applications Sent</p>
                <p className="text-[#787774] text-lg">By our users last month</p>
              </div>
              <div>
                <div className="text-6xl font-black text-black mb-4">3.2x</div>
                <p className="text-xl font-medium text-black">More Interviews</p>
                <p className="text-[#787774] text-lg">Compared to manual applying</p>
              </div>
              <div>
                <div className="text-6xl font-black text-black mb-4">92%</div>
                <p className="text-xl font-medium text-black">Success Rate</p>
                <p className="text-[#787774] text-lg">Of users land jobs in 90 days</p>
              </div>
            </div>
          </FadeIn>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-[#9B9A97] max-w-2xl mx-auto mb-12">
