...
export default function AuthorPage() {
  ...
  const authorGuides = Object.entries(guides as Record<string, any>).filter(
    ([slug, guide]: [string, any]) => guide.authorId === authorId,
  );
  ...
  if (!author) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <SEO
          title="Author Not Found | JobHuntin"
        ...
        schema={[
          {
            ...
            image: author.image.startsWith("http")
              ? author.image
              : `https://jobhuntin.com${author.image.startsWith("/") ? "" : "/"}${author.image}`,
          },
          {
            "@context": "https://schema.org",
            "@type": "ProfilePage",
