...
interface ConfirmContactStepProperties {
...
export function ConfirmContactStep({
  ...
  const handlePhoneChange = (value: string) => {
    ...
    if (formatted && !isValidPhoneNumber(formatted) && onSetFormError) {
      onSetFormError(
        "phone",
        t("onboarding.phoneInvalid", locale) ||
    ...
    <div role="region" aria-labelledby="confirm-contact-step-title">
      ...
      {Object.keys(formErrors).length > 0 && (
        <div role="alert" aria-live="polite" className="sr-only">
          {t("onboarding.formErrors", locale) || "Form has"}{" "}
          {Object.keys(formErrors).length}{" "}
          {Object.keys(formErrors).length > 1
            ? t("onboarding.errorsPlural", locale) || "errors"
            : t("onboarding.errorsSingular", locale) || "error"}
          :
      ...
      <div className="mb-4 md:mb-6 flex items-center gap-3 md:gap-4 border-b border-[#E9E9E7] pb-4 md:pb-6">
        ...
        <div className="min-w-0">
          <h2
            id="confirm-contact-step-title"
            className="font-display text-lg md:text-2xl font-bold text-[#2D2A26] tracking-tight"
          >
      ...
      <div className="grid gap-4 md:gap-6">
        <div className="grid grid-cols-2 gap-3 md:gap-4">
          <div>
            ...
            <Input
              ...
              type="text"
              placeholder={
                t("onboarding.firstNamePlaceholder", locale) || "John"
              }
        ...
        <div>
          ...
          <Input
            ...
            autoComplete="email"
            placeholder={
              t("onboarding.emailPlaceholder", locale) || "john@example.com"
            }
          ...
          <p className="mt-1 text-[10px] text-slate-400">
            {t("onboarding.emailPrivacy", locale) ||
          ...
          <AnimatePresence>
            {emailTypoSuggestion && onApplyEmailSuggestion && (
              ...
              >
                ...
                >
                  {t("onboarding.didYouMean", locale)}{" "}
        ...
        <div>
          ...
          <Input
            ...
            autoComplete="tel"
            placeholder={
              t("onboarding.phonePlaceholder", locale) || "+1 (555) 123-4567"
            }
        ...
        {parsedResume && (
          <div className="p-3 md:p-4 rounded-xl bg-emerald-50 border border-emerald-100">
            ...
            <p className="text-xs text-emerald-800 font-medium">
              {t("onboarding.verifyDetails", locale) ||
                "We pre-filled these from your resume. Please verify details."}
            </p>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-4 mt-4">
        ...
        <Button
          ...
          aria-label={
            t("onboarding.confirmIdentity", locale) ||
