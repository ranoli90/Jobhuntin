...
interface CareerGoalsStepProperties {
  onNext: () => void;
  onPrev: () => void;
  careerGoals: {
...
const EXPERIENCE_LEVELS = [
  {
    value: "0-1",
    labelKey: "onboarding.expLevelEntry",
    subKey: "onboarding.expLevelEntrySub",
    gradient: "from-sky-400 to-blue-500",
  },
  {
    value: "1-3",
    labelKey: "onboarding.expLevelJunior",
    subKey: "onboarding.expLevelJuniorSub",
    gradient: "from-teal-400 to-emerald-500",
  },
  {
    value: "3-5",
    labelKey: "onboarding.expLevelMid",
    subKey: "onboarding.expLevelMidSub",
    gradient: "from-amber-400 to-orange-500",
  },
  {
    value: "5-10",
    labelKey: "onboarding.expLevelSenior",
    subKey: "onboarding.expLevelSeniorSub",
    gradient: "from-violet-400 to-purple-600",
  },
  {
    value: "10+",
    labelKey: "onboarding.expLevelStaff",
    subKey: "onboarding.expLevelStaffSub",
...
const URGENCY_OPTIONS = [
  {
    value: "active",
    icon: Flame,
    labelKey: "onboarding.urgencyActive",
    descKey: "onboarding.urgencyActiveDesc",
    color: "border-red-200 bg-red-50/50 hover:border-red-300",
    iconColor: "text-red-500",
  },
  {
    value: "open",
    icon: Eye,
    labelKey: "onboarding.urgencyOpen",
    descKey: "onboarding.urgencyOpenDesc",
  ...
  },
  {
    value: "exploring",
    icon: Sprout,
    labelKey: "onboarding.urgencyExploring",
    descKey: "onboarding.urgencyExploringDesc",
...
const GOALS = [
  ...
  {
    value: "management",
    labelKey: "onboarding.goalManagement",
    icon: Briefcase,
  },
  {
    value: "career_change",
    labelKey: "onboarding.goalCareerChange",
    icon: Target,
  },
  {
    value: "higher_comp",
    labelKey: "onboarding.goalHigherComp",
    icon: DollarSign,
  },
...
export function CareerGoalsStep({
  ...
  return (
    <div
      ...
      role="region"
      aria-labelledby="career-goals-step-title"
    >
      <div className="flex-1">
        ...
        <div className="mb-4 md:mb-6 flex items-center gap-3 md:gap-4 border-b border-slate-100 pb-4 md:pb-6">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs md:text-sm text-slate-500 font-medium">
              {t("onboarding.careerGoalsSubtitle", locale) ||
            ...
            {EXPERIENCE_LEVELS.map((level) => {
              ...
              return (
                <button
                  ...
                  onClick={() =>
                    setCareerGoals((previous) => ({
                      ...previous,
                      experience_level: level.value,
                    }))
                  }
                  className={`relative min-h-[44px] p-3 rounded-xl text-center transition-all border-2 ${
                    isSelected
                ...
                >
                  <div
                    className={`mx-auto w-8 h-8 rounded-lg bg-gradient-to-br ${level.gradient} mb-2 flex items-center justify-center ${isSelected ? "shadow-lg" : ""}`}
                  >
                  ...
                  <p className="text-[10px] md:text-xs font-bold text-slate-900">
                    {t(level.labelKey, locale) || level.labelKey}
                  </p>
                  <p className="text-[8px] md:text-[10px] text-slate-400">
                    {t(level.subKey, locale) || level.subKey}
                  </p>
                </button>
              );
            })}
            ...
            {URGENCY_OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 min-h-[44px] p-3 md:p-4 rounded-xl text-left transition-all border-2 ${
                    isSelected
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${isSelected ? "bg-primary-100" : "bg-white"}`}
                  >
                    <UrgencyIcon
                      className={`w-5 h-5 ${isSelected ? "text-primary-600" : option.iconColor}`}
                    />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-slate-900">
                      {t(option.labelKey, locale) || option.labelKey}
                    </p>
                    <p className="text-xs text-slate-500">
                      {t(option.descKey, locale) || option.descKey}
                    </p>
                  </div>
                </button>
              );
        ...
        <div className="mb-6">
          ...
          <div
            ...
            role="radiogroup"
            aria-label="Primary career goal"
          >
            {GOALS.map((goal) => {
              ...
              return (
                <button
                  ...
                  onClick={() =>
                    setCareerGoals((previous) => ({
                      ...previous,
                      primary_goal:
                        previous.primary_goal === goal.value ? "" : goal.value,
                    }))
                  }
                  className={`flex items-center gap-2 min-h-[44px] p-3 rounded-xl text-left transition-all border-2 ${
                    isSelected
                ...
                >
                  <Icon
                    className={`w-4 h-4 shrink-0 ${isSelected ? "text-primary-600" : "text-slate-400"}`}
                  />
                  <span className="text-xs font-bold text-slate-700">
                    {t(goal.labelKey, locale) || goal.labelKey}
                  </span>
                </button>
              );
            })}
        ...
        <div className="mb-4">
          <label className="mb-3 flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            ...
            {t("onboarding.whyLeaving", locale) || "Why are you looking?"}{" "}
          ...
          <div
            ...
            role="radiogroup"
            aria-label="Why are you looking"
          >
            {REASONS.map((reason) => {
                ...
                <button
                  ...
                  onClick={() =>
                    setCareerGoals((previous) => ({
                      ...previous,
                      why_leaving:
                        previous.why_leaving === reason.value
                          ? ""
                          : reason.value,
                    }))
                  }
                  className={`min-h-[44px] px-4 py-2 rounded-full text-xs font-bold transition-all border flex items-center ${
                    isSelected
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-4 mt-4 shrink-0">
        ...
        <Button
          ...
          onClick={onNext}
          disabled={
            isSaving || !careerGoals.experience_level || !careerGoals.urgency
          }
