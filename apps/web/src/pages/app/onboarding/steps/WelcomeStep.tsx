...
export function WelcomeStep({ onNext, shouldReduceMotion }: WelcomeStepProps) {
    return (
        <div>
            ...
            <Button type="button" onClick={onNext} className="w-full h-11 md:h-12 rounded-xl font-bold text-base md:text-lg shadow-lg shadow-primary-500/20 bg-primary-600 hover:bg-primary-500 group" aria-label="Get Started">
                Get Started
