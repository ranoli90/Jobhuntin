    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="sticky bottom-0 pt-2 md:pt-4 shrink-0 mt-auto bg-gradient-to-t from-white via-white/95 to-transparent backdrop-blur">
                <Button size="lg" onClick={onNext} className="w-full h-10 md:h-12 rounded-[1.25rem] text-base md:text-xl font-black shadow-xl md:shadow-2xl shadow-primary-500/30 bg-primary-600 hover:bg-primary-500 hover:scale-[1.02] transition-all group" aria-label="Get Started">
                    GET STARTED
