    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">AI-powered interview preparation with mastery tracking</p>
        </div>
      ...
      <Alert>
        <AlertDescription>
          Practice interview questions with AI-powered feedback and track your improvement over time.
        </AlertDescription>
      </Alert>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Technical question • Score: 8/10</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Behavioral question • Score: 9/10</div>
                  </div>
                </div>
                <div className="text-right">
