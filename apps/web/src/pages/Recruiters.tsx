...
export default function Recruiters() {
  ...
  return (
    <div
      className={`min-h-[calc(100vh-80px)] transition-colors duration-500 ${view === "terminal" ? "bg-[#0d1117] text-gray-300" : "bg-slate-50 text-slate-900"}`}
    >
      <SEO
        ...
        schema={[
          {
            ...
            description:
              "AI-powered candidate screening and structured data delivery for recruiters.",
            provider: {
              "@type": "Organization",
              name: "JobHuntin",
            },
      ...
      <main className="max-w-7xl mx-auto px-6 py-24 relative">
        ...
        <div className="flex justify-center mb-16">
          <div
            className={`p-1 rounded-full flex gap-1 relative shadow-sm border ${view === "terminal" ? "bg-gray-800 border-gray-700" : "bg-white border-slate-200"}`}
          >
            {!shouldReduceMotion && (
              <motion.div
                layoutId="activeTab"
          ...
          {view === "human" ? (
            ...
            >
              <div className="text-center">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-sans font-black mb-6 leading-tight text-slate-900 text-balance">
                  ...
                  <span className="text-primary-600 font-black">
                    not keyword stuffers.
                  </span>
                </h1>
                <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-8 font-medium text-balance">
                  Our AI pre-interviews every candidate before they reach your
                  inbox. You get structured data, not PDF chaos.
                </p>
                <Button
                  variant="secondary"
                  size="lg"
                  className="px-6 sm:px-8 py-3 sm:py-4 h-auto rounded-xl text-base sm:text-lg shadow-lg hover:shadow-primary-500/20"
                >
                  Request API Access
                </Button>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="relative">
                  <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-xl relative border border-slate-100">
                    <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-4">
                      <img
                        src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=64&q=80"
                        alt="Michael Chen - Top Talent Candidate"
                    ...
                    <div className="space-y-4">
                      <div className="bg-slate-50 p-4 rounded-xl">
                        <p className="text-xs font-bold text-slate-400 uppercase mb-1">
                          Q: Experience with Leadership?
                        </p>
                        <p className="text-sm text-slate-800 font-medium">
                          "Yes, I've managed a team of 15 warehouse workers for
                          3 years..."
                        </p>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-xl">
                ...
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold font-display mb-6 text-slate-900">
                    Structured Candidate Cards
                  </h3>
                  <p className="text-slate-500 text-base sm:text-lg leading-relaxed mb-6 font-medium">
                    Stop parsing PDFs. We deliver JSON-ready profiles with
                    verified answers to your screening questions.
                  </p>
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto mb-8 text-balance">
                  Direct pipe to the top 1% of the market. Webhooks, JSON
                  streams, and zero UI friction.
                </p>
                <Button
                  variant="outline"
                  size="lg"
                  className="border-emerald-500 text-emerald-500 bg-transparent hover:bg-emerald-500/10 px-6 sm:px-8 py-3 sm:py-4 h-auto rounded-xl font-bold transition-colors"
                >
                  Generate API Key
                </Button>
              </div>
                ...
                <div className="p-4 sm:p-6 text-xs sm:text-sm text-gray-300 overflow-x-auto font-mono leading-relaxed">
                  <div className="min-w-[300px] sm:min-w-[500px]">
                    <p className="mb-2">
                      ...
                      <span className="text-blue-400">~</span> curl -X POST
                      https://api.jobhuntin.io/webhook \
                    </p>
                    <p className="mb-2 pl-4">
                      -H "Authorization: Bearer sk_live_..." \
                    </p>
                    <p className="mb-4 pl-4">
                      -d {'{\"criteria\": [\"react\", \"node\", \"5+ years\"]}'}
                    </p>

                    <p className="mb-2 text-gray-500">
                      # Response stream initiating...
                    </p>
                    ...
                    <p className="mb-1 pl-8">
                      "q1_scale": "Architected k8s cluster for...",
                    </p>
