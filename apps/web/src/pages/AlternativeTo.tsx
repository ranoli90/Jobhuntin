  ...
  if (!competitor) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-slate-50">
        <SEO
          title="Alternative Not Found | JobHuntin"
          description="We don't have an alternative page for this tool yet."
          noindex
        />
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-primary-500/20 selection:text-primary-700">
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: competitor.name + " Alternative", url: canonicalUrl },
        ]}
            ...
            itemListElement: [
              {
                ...
                description:
                  "Autonomous AI job search automation with stealth mode and resume tailoring",
              },
            ],
          },
          // FAQPage Schema
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <p className="text-slate-700 font-medium leading-relaxed">
                JobHuntin is the best {competitor.name} alternative — fully
                autonomous AI with stealth mode.
              </p>
              <p className="text-slate-600 text-sm mt-1 font-medium">
                Per-application resume tailoring and 24/7 auto-apply. No data
                migration needed to switch.
              </p>
            </div>
            <Link
              to="/login"
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3 text-sm text-slate-700">
                  ...
                  <span className="font-medium">
                    Chrome extension for real-time job capture from any site
                  </span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-700">
                  <span className="text-emerald-500 mt-0.5 flex-shrink-0">
                  ...
                  <span className="font-medium">
                    AI cover letters crafted for each specific job description
                  </span>
                </li>
              </ul>
            </div>
