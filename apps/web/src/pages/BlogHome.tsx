...
const blogPosts = [
  {
    ...
    excerpt:
      "An honest, in-depth analysis of Jobright AI. We test every feature, compare pricing, and reveal whether it's worth your time in 2026.",
    category: "Reviews",
    date: "2026-02-14",
    readTime: "8 min",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(69,93,211,0.2) 0%, rgba(23,190,187,0.1) 100%)",
  },
  {
    slug: "ai-job-application-tools-compared",
    title: "AI Job Application Tools Compared: Which One Actually Works?",
    excerpt:
      "We tested 12 AI job application tools side-by-side. Here's what actually gets you interviews.",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(23,190,187,0.2) 0%, rgba(69,93,211,0.15) 100%)",
  },
  {
    slug: "how-to-auto-apply-jobs",
    title: "How to Auto-Apply to Jobs: Complete Guide for 2026",
    excerpt:
      "Everything you need to know about automated job applications. Setup, best practices, and how to avoid common pitfalls.",
    category: "Guides",
    date: "2026-02-10",
    readTime: "10 min",
    author: "JobHuntin Team",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(234,88,12,0.15) 0%, rgba(69,93,211,0.1) 100%)",
  },
  {
    slug: "ats-resume-optimization",
    title: "ATS Resume Optimization: How to Beat the Bots in 2026",
    excerpt:
      "Learn exactly how Applicant Tracking Systems work and how to format your resume to pass every time.",
    category: "Guides",
    date: "2026-02-08",
    readTime: "7 min",
    author: "JobHuntin Team",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(22,163,74,0.15) 0%, rgba(69,93,211,0.1) 100%)",
  },
  {
    slug: "job-search-statistics-2026",
    title: "Job Search Statistics 2026: Data-Driven Insights",
    excerpt:
      "The latest data on job market trends, application success rates, and what's working for job seekers right now.",
    category: "Data",
    date: "2026-02-06",
    readTime: "6 min",
    author: "JobHuntin Team",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(69,93,211,0.15) 0%, rgba(23,190,187,0.1) 100%)",
  },
  {
    slug: "interview-success-stories",
    title: "Interview Success Stories: Real Users Share Their Experience",
    excerpt:
      "How 5 job seekers landed their dream jobs using AI-powered tools. Their exact strategies revealed.",
    ...
    heroGradient:
      "linear-gradient(135deg, rgba(234,88,12,0.15) 0%, rgba(23,190,187,0.12) 100%)",
  },
];
...
export default function BlogHome() {
  ...
  const description =
    "Expert insights on AI-powered job search. Tool reviews, application strategies, interview tips, and real success stories from job seekers who landed their dream jobs.";
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] font-sans text-[#2D2A26]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          <h1
            className="text-[clamp(2rem,4vw,3rem)] font-bold text-[#2D2A26] mb-4 tracking-tight"
            style={{ letterSpacing: "-0.5px" }}
          >
            Job Search Intelligence
          </h1>
          <p className="text-lg sm:text-xl text-[#787774] max-w-2xl mx-auto leading-relaxed">
            In-depth guides, honest reviews, and data-driven insights to help
        ...
        <div className="mb-12 sm:mb-16">
          <h2 className="text-xl sm:text-2xl font-bold text-[#2D2A26] mb-6 sm:mb-8">
            Featured Articles
          </h2>
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4 sm:gap-6">
                    <div
                      className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl flex-shrink-0 flex items-center justify-center overflow-hidden"
                      style={{ background: post.heroGradient }}
                    >
                      <img
                        src={post.heroImage}
