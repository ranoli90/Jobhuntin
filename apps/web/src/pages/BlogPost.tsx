...
const relatedPosts = [
  {
    ...
    title: "AI Job Application Tools Compared",
    category: "Comparisons",
  },
  {
    slug: "how-to-auto-apply-jobs",
    title: "How to Auto-Apply to Jobs",
    category: "Guides",
  },
  {
  ...
  if (!post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-[#F7F6F3]">
        <SEO
          title="Article Not Found | JobHuntin"
          description="The requested article could not be found."
          noindex
        />
        <h1 className="text-2xl font-bold mb-4 text-[#2D2A26]">
          Article Not Found
        </h1>
        <Link
          to="/blog"
          className="text-[#455DD3] hover:underline flex items-center gap-2 font-medium"
        >
    ...
    <div className="min-h-screen bg-white font-sans text-[#2D2A26]">
      ...
      <main className="max-w-[720px] mx-auto px-6 sm:px-8 py-8 sm:py-12">
        ...
        <nav className="mb-6 sm:mb-8">
          <Link
            to="/blog"
            className="text-[#455DD3] hover:underline flex items-center gap-2 text-sm font-medium"
          >
            <ArrowLeft className="w-4 h-4" /> Back to Blog
          </Link>
        </nav>
        ...
        >
          ...
          <h1
            className="text-[clamp(1.75rem,4vw,2.75rem)] font-bold text-[#2D2A26] mb-4 tracking-tight leading-[1.2]"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                The JobHuntin team writes about AI job search, automation, and
                career tips. We build the tools that help job seekers land more
                interviews.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-[#F7F6F3] flex items-center justify-center text-[#787774] hover:bg-[#455DD3]/10 hover:text-[#455DD3] transition-colors"
              >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {relatedPosts
              ...
              .map((relatedPost) => (
                ...
                >
                  <span className="text-xs font-semibold text-[#455DD3]">
                    {relatedPost.category}
                  </span>
                  <h3 className="font-semibold text-[#2D2A26] mt-2">
                    {relatedPost.title}
                  </h3>
                </Link>
              ))}
