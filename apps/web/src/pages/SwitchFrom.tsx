...
const MIGRATION_STEPS = [
  ...
  },
  {
    ...
    description:
      "Upload your existing resume. Our AI will analyze it to understand your skills and experience.",
    time: "1 minute",
  },
  {
    icon: Settings,
    ...
    description:
      "Choose your target roles, locations, salary range, and job boards. The AI agent handles the rest.",
    time: "2 minutes",
  },
  {
    icon: Zap,
    ...
    description:
      "Turn on the autonomous agent. It will discover jobs, tailor your resume for each one, and auto-apply — all with stealth mode enabled.",
    time: "1 click",
  },
];
  ...
  if (!competitor) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-slate-50">
        <SEO
          title="Migration Guide Not Found | JobHuntin"
          description="We don't have a migration guide for this tool yet."
          noindex
        />
      ...
      <main className="max-w-4xl mx-auto px-6 py-24">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-sans font-black mb-6 leading-tight text-slate-900">
            ...
            to <span className="text-primary-600 font-black">JobHuntin</span>
          </h1>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <p className="text-slate-700 font-medium leading-relaxed">
                Switch from {competitor.name} to JobHuntin in under 5 minutes —
                no data migration.
              </p>
              <p className="text-slate-600 text-sm mt-1 font-medium">
                Upload resume, set preferences, activate the AI agent. Start
                applying with stealth mode immediately.
              </p>
            </div>
            <Link
              to="/login"
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              "Detailed application tracking dashboard",
                ...
                <div key={index} className="flex items-start gap-3 p-3 rounded-xl hover:bg-emerald-50 transition-colors">
