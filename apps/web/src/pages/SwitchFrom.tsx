...
export default function SwitchFrom() {
    ...
    const title = `Switch from ${competitor.name} to JobHuntin — 5-Minute Migration Guide`;
    const description = `Ready to upgrade from ${competitor.name}? Switch to JobHuntin's autonomous AI agent in under 5 minutes. Step-by-step migration guide with zero data loss.`;
