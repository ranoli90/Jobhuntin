  ...
  return (
    <section className="py-16 sm:py-20 bg-slate-50">
      <div className="max-w-[720px] mx-auto px-6">
        <h2
          className="text-[clamp(1.75rem,3.5vw,28px)] font-bold text-[#2D2A26] mb-10 text-center"
            ...
            >
              ...
              {openIndex === index && (
                <div
                  ...
                  role="region"
                  aria-labelledby={`faq-accordion-question-${index}`}
                  className="px-5 sm:px-6 pb-5 pt-0 text-[15px] text-[#787774] leading-[1.6] border-t border-[#F1F1EF]"
                >
                  <p>{item.answer}</p>
                </div>
              )}
