      ...
      <div className="relative group">
        ...
        {isPassword && !onClear && (
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-primary-500 p-1 rounded-full hover:bg-slate-100 transition-all duration-200"
        ...
        {onClear && value && !isPassword && (
          <button
            type="button"
            onClick={onClear}
            className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-red-500 p-1 rounded-full hover:bg-red-50 transition-all duration-200"
