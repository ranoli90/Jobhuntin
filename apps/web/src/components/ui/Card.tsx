...
const cardVariants = cva("rounded-xl border p-6 transition-all duration-200", {
  variants: {
    variant: {
    ...
    tone: {
      ...
      glass:
        "bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-white/50 dark:border-slate-700/50 shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50",
    },
  },
  defaultVariants: {
    variant: "default",
...
export const CardFooter = ({
  ...
  <div className={`px-6 pb-6 pt-2 border-t border-slate-100 ${className}`}>
    {children}
  </div>
);
