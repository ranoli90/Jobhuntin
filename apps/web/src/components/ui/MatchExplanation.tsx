...
export interface MatchExplanationProperties {
      ...
      <div className="flex gap-3">
        <div
          className={cn(
            ...
            explanation.location_compatible
              ? "text-emerald-600"
              : "text-slate-400",
          )}
        >
