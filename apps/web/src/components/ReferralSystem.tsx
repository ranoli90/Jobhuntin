...
interface ReferralModalProperties {
  isOpen: boolean;
  onClose: () => void;
  userName?: string;
}
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <p className="text-xs text-center text-slate-500">
                  Your friends get 50% off their first month. You get 50% off
                  for each friend who subscribes.
                </p>
              </div>
            </motion.div>
          </FocusTrap>
...
interface ReferralButtonProperties {
  className?: string;
}

export function ReferralButton({ className }: ReferralButtonProperties) {
