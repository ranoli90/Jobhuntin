...
const JOURNEY_STEPS = [
  {
    ...
    description:
      "Our AI agents scan 50+ job boards every hour, analyzing thousands of listings to find roles that actually match your skills, salary expectations, and career goals—not just keyword matches.",
    stat: "2,400+",
  ...
  },
  {
    ...
    description:
      "Generic resumes get ignored. We analyze each company's culture, tech stack, and job requirements to craft personalized applications that speak their language and highlight your relevant wins.",
    stat: "87%",
  ...
  },
  {
    ...
    description:
      "Review and approve each application in seconds. We handle the tedious forms, cover letters, and submissions. Apply to 50 jobs in the time it takes to drink your coffee.",
    stat: "50x",
  ...
  },
  {
    ...
    description:
      "Track every application in real-time. When responses come in, we surface them instantly. Your only job? Show up and nail the interview. We'll even prep you with company research.",
    stat: "3.2x",
...
function StepVisual({ type, color }: { type: string; color: string }) {
  ...
  const isInView = useInView(containerReference, {
    once: true,
    margin: "-100px",
  });
      ...
      {type === "search" && (
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="relative">
            ...
            />
            <div
              className={`w-32 h-32 rounded-full bg-gradient-to-br ${color} flex items-center justify-center shadow-2xl`}
            >
              <svg
          ...
          <div className="relative">
            ...
            {Array.from({ length: 12 }).map((_, index) => (
              <motion.div
                ...
                animate={{
                  x: [0, (index - 6) * 30, (index - 6) * 40],
                  y: [0, -100 - index * 10, -150],
                  rotate: [0, 360, 720],
                  opacity: [1, 1, 0],
                }}
                transition={{
      ...
      >
        ...
        >
          ...
          <p className="mt-6 text-lg text-slate-400 max-w-2xl mx-auto">
            Four powerful stages that transform job hunting from a grind into a
              ...
              >
                ...
                <div className={`${isEven ? "lg:order-1" : "lg:order-2"}`}>
                  <div className="flex items-center gap-4 mb-6">
                    <span
                      className={`text-5xl font-bold bg-gradient-to-r ${step.color} bg-clip-text text-transparent`}
                    >
                      {step.number}
                    </span>
