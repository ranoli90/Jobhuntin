...
const FAQS = [
  {
    ...
    answer:
      "100% compliant with every platform's Terms of Service. We send tailored, high-quality applications — the kind recruiters actually want to read.",
    icon: Shield,
  ...
  },
  {
    ...
    answer:
      "You spend 30 minutes per app. We do it in under 2 — with a custom resume and cover letter for every single role. 50 tailored applications a day, every day, while you focus on interviews.",
    icon: Zap,
  ...
  },
  {
    ...
    answer:
      "Encrypted, never sold, deletable anytime with one click. We only use your resume to generate applications — you approve every one before it sends.",
    icon: Lock,
  ...
  },
  {
    ...
    answer:
      "Nope. Every application comes from your email with your name. Employers see a polished candidate — never a bot.",
    icon: Eye,
  ...
  },
  {
    ...
    answer:
      "You see every application before it goes out. Edit the cover letter, tweak resume bullets, or skip entirely — you're always in control.",
    icon: Edit3,
  ...
  },
  {
    ...
    answer:
      "Free to start — 10 applications on us, no credit card. Pro is $19/mo for unlimited, Teams $49/seat. One interview covers it for life.",
    icon: CreditCard,
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg text-slate-400 max-w-2xl mx-auto">
            We know job hunting is stressful enough. Here's everything you need
            to know, explained like a human would.
          </p>
        </motion.div>
