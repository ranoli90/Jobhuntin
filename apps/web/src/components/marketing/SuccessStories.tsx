...
const successStories: SuccessStory[] = [
  {
    ...
    testimonial: 'The AI resume optimization was a game-changer. My resume matched job descriptions perfectly.',
    avatar: 'SC',
    timeToHire: '6 weeks',
    salaryIncrease: '35%',
  },
  {
    ...
    after: 'Multiple companies reached out within 2 weeks of using the platform',
    testimonial: 'The AI-powered matching found opportunities I never would have discovered.',
    avatar: 'MR',
    timeToHire: '4 weeks',
    salaryIncrease: '28%',
  },
  {
    ...
    testimonial: 'The tailored resumes helped me land my dream job at a top design firm.',
    avatar: 'EJ',
    timeToHire: '3 weeks',
    salaryIncrease: '22%',
  },
  {
    ...
    testimonial: 'The skills validation and keyword optimization made all the difference.',
    avatar: 'DK',
    timeToHire: '5 weeks',
    salaryIncrease: '40%',
  },
  {
    ...
    testimonial: 'I went from struggling to get responses to having multiple offers.',
    avatar: 'LT',
    timeToHire: '4 weeks',
    salaryIncrease: '25%',
  },
  {
    ...
    testimonial: 'The automation features allowed me to focus on interview preparation.',
    avatar: 'JW',
    timeToHire: '3 weeks',
    salaryIncrease: '30%',
  },
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-900 font-medium mb-4">{story.after}</p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{story.timeToHire}</div>
                    <div className="text-sm text-gray-600">Time to Hire</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{story.salaryIncrease}</div>
              ...
              <div className="relative h-64 md:h-auto">
                ...
                <div className="relative h-full flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-6xl font-bold mb-2">{story.avatar}</div>
          ...
          <div className="flex items-center justify-center space-x-4 mt-8">
            ...
            >
              <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7-7" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7-7" />
              </svg>
            </button>
