...
const Navigation: React.FC<NavigationProps> = ({
  ...
  if (variant === 'sidebar') {
    return (
      <nav className={cn('w-64 bg-white border-r border-gray-200 h-full overflow-y-auto', className)}>
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/guides" className="text-sm text-gray-600 hover:text-gray-900">
                    Guides
                  </a>
                </li>
                <li>
